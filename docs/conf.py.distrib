...
try:
    ...
    version = git_dump_diff.__version__
    project = git_dump_diff.__title__
    copyright = git_dump_diff.__copyright__
    author = git_dump_diff.__author__
except ImportError:
    version = "0.1"
    project = "git-dump-diff"
